...
namespace HutongGames.PlayMaker.Actions
{
     ...
     public class GetAxisVector : FsmStateAction
     {
          ...
          public override void OnUpdate()
          {
               ...
               var h = (horizontalAxis.IsNone || string.IsNullOrEmpty(horizontalAxis.Value)) ? 0f : joystick.Horizontal;
               var v = (verticalAxis.IsNone || string.IsNullOrEmpty(verticalAxis.Value)) ? 0f : joystick.Vertical;
