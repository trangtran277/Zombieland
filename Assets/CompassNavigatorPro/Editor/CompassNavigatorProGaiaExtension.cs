...
namespace Gaia.GX.Kronnect
{
	...
	public class CompassNavigatorProGaiaExtension : MonoBehaviour
    {
		...
		public static void GX_AddCompassBar() {
			...
			GameObject cnpRef = Resources.Load<GameObject> ("Prefabs/CompassNavigatorPro");
			if (cnpRef == null) {
		...
		public static void GX_PopulateCompassBar() {
			...
			Sprite iconGenericBlack = Resources.Load<Sprite>("Sprites/icon-arrow-black");
			Sprite iconGenericWhite = Resources.Load<Sprite>("Sprites/icon-arrow-white");
			Sprite iconMonolithBlack = Resources.Load<Sprite>("Sprites/icon-monolith-black");
			Sprite iconMonolithWhite = Resources.Load<Sprite>("Sprites/icon-monolith-white");
			Sprite iconMineBlack = Resources.Load<Sprite>("Sprites/icon-mine-black");
			Sprite iconMineWhite = Resources.Load<Sprite>("Sprites/icon-mine-white");
			Sprite iconCityBlack = Resources.Load<Sprite>("Sprites/icon-city-black");
			Sprite iconCityWhite = Resources.Load<Sprite>("Sprites/icon-city-white");
			Sprite iconForestBlack = Resources.Load<Sprite>("Sprites/icon-forest-black");
			Sprite iconForestWhite = Resources.Load<Sprite>("Sprites/icon-forest-white");
			...
			for (int k=0;k<spawnedRoot.transform.childCount;k++) {
				...
				Bounds bounds = new Bounds(spawned.transform.position, Vector3.zero);
